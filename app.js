...
const galaxy_Services = require('./galaxy_Services');
...
const workspaceJson = JSON.parse(fs.readFileSync('data/conversation/workspaces/galaxyS8.json'));
...
app.post('/api/message', function(req, res) {
  ...
  galaxy_Services.getPhone(0.7, function(err, phone) {
    if (err) {
